...
export const onModuleNavigate =(path,absolutePathArray)=>{
  return {
    type: MODULE_NAVIGATE,
    path:path,
    absolutePathArray:absolutePathArray
  }
}

export const onModuleScaned = (files)=>{
  return {
...
export const onJSONData= (id,path,utf8Data)=>{
   return {
    type: GET_JSON_DATA,
    id:id,
    absolutePath:path,

...
import CustomizeInspector from './CustomizeInspector'
import PrototypeInspector from './PrototypeInspector'
import ProjectNavigator from './ProjectNavigator'
import ComponentBrowser from './ComponentBrowser'
import Pane from '../components/layout/Pane'
import NpmLoginModalButton from '../components/buttons/NpmLoginModalButton';
import NpmInitModalButton from '../components/buttons/NpmInitModalButton';
...
class Workspace extends Component {
  ...
  renderInspector(rightPaneStyle) {
    ...
    switch (this.props.rightSidebarContent) {
      ...
      break;
      case RIGHT_SIDEBAR_CONTENT.CUSTOMIZE:
           content = (
          <CustomizeInspector
            width={this.props.rightSidebarWidth}
            decoDoc={this.props.decoDoc} />
      ...
      break;
      case RIGHT_SIDEBAR_CONTENT.PROTOTYPE:
          content = (
            <PrototypeInspector
              width={this.props.rightSidebarWidth}
              decoDoc={this.props.decoDoc} />
    ...
    return (
      <div className='vbox full-size-relative' style={{overflow: 'hidden',}}>
        ...
        <div className='flex-variable hbox' style={containerStyle}>
          ...
          <NpmLoginModalButton isShowingModal={this.props.npm.isLoginVisible} 
              onClose={()=>{
                  this.props.dispatch(makeLoginUnVisible())
              }}
             
              />

          <NpmInitModalButton isShowingModal={this.props.npm.isInitVisible}
            onClose={()=>{
                    this.props.dispatch(makeInitUnVisible())
                }}

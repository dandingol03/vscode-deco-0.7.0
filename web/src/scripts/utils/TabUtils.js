...
class TabUtils {
  ...
  static swapTab(container, tabId, newTabId) {
    ...
    //TODO:we must make a deal,firstly i wanto make newTab existed,and old tab will not be replaced
    // if(newTabIds.indexOf(newTabId)==-1)
    //   newTabIds.splice(newTabIds.length,0,newTabId);
